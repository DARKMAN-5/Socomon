...
// ***************************************************only friends can see post************************************
  mysqlconnection.query(
    ...
    "SELECT * FROM post LEFT JOIN post_like ON post.post_id = post_like.post_like_post_id and post_like.post_like_user_id=? WHERE post_user_id IN (SELECT friend_id FROM friends WHERE user_id=?) OR post_user_id=?; ",
...
router.post("/addfriend/", function (req, response, next) {
...
router.post("/removefriend/", function (req, response, next) {
  // console.log(req.body.friend);
  // console.log(req.session.userName);
...
router.post("/addLike/", function (req, response, next) {
  // console.log(req.body.friend);
  // console.log(req.session.userName);
...
router.post("/countlikes/",function(req,res){
...
router.post("/checksendmessage/",function(req,res){
...
router.post("/showpostprofile/",function(req,res){
...
router.post("/showlikelist/",function(req,res){
...
router.post("/checkdeletewelcomezoom/",function(req,res){
